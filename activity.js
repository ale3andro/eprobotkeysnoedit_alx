...
function showCommand(cmdCode,cell){
  ...
  childNode.style.left="20px";
  childNode.style.top="10px";
  childNode.style.opacity='40%';
  childNode.innerHTML=(cell+1).toString();
  const fNode =  document.getElementById('cell'+cell.toString());
